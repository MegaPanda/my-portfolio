...
function Home() {
    return (
        <Box w="100%" h="100vh" position="relative">
            ...
            h="0" animate={{ height: "80px", transition: { delay: 1, duration: 1 } }} />
            ...
            display="flex" flexDirection="column" justifyContent="end" position="relative" overflow="hidden">
                ...
                <MotionBox pl={[5, 16]} color="orange.400" fontWeight="bold"
                initial={{ height: "80px", translateY: "80px" }} animate={{ translateY: 0, transition: { delay: 1, duration: 1 } }}>
